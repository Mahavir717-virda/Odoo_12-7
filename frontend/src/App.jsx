  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/environmental/environmental-goals" element={<Environmental />} />
        <Route path="/social" element={<Social />} />
        <Route path="/social/csr-activities" element={<Social />} />
        <Route path="/social/employee-participation" element={<Social />} />
        <Route path="/governance" element={<Governance />} />
        <Route path="/governance/audits" element={<Governance />} />
        <Route path="/governance/compliance-issues" element={<Governance />} />
        <Route path="/gamification" element={<Gamification />} />
        <Route path="/gamification/challenges" element={<Gamification />} />
        <Route path="/reports" element={<Reports />} />
        <Route path="/reports/esg-summary" element={<Reports />} />
        <Route path="/settings" element={<Settings />} />
        <Route path="/settings/departments" element={<Settings />} />
