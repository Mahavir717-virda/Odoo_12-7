      ...
      <div className="w-full max-w-[400px] bg-[#11161D] border border-white/10 rounded-2xl p-8 shadow-xl flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex bg-[#0B0F14] border border-white/10 rounded-lg p-1">
              <button
                type="button"
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500 font-medium">
            ...
            <Link to="/login" className="text-cyan-400 hover:text-cyan-300 hover:underline transition-colors ml-1">
              Log in
            </Link>
          </p>
        </div>
